    ...
    extend: {
      ...
      colors: {
        ...
        teal: {
          ...
          hover: "oklch(var(--teal-hover))",
          light: "oklch(var(--teal-light))",
        },
        "wa-green": {
          DEFAULT: "oklch(var(--wa-green))",
          hover: "oklch(var(--wa-green-hover))",
        },
        "section-alt": "oklch(var(--section-alt))",
        "icon-circle": "oklch(var(--icon-circle))",
      ...
      boxShadow: {
        ...
        "card-hover": "0 8px 28px 0 rgba(0,0,0,0.13)",
