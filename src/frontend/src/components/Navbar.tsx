  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-card-border shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        ...
        >
          <div className="bg-white border border-gray-100 rounded-xl p-0.5 shadow-sm flex-shrink-0">
            <img
          ...
          {navLinks.map((link) =>
            link.external ? (
              <a
                ...
                className="relative px-3 py-2 text-sm font-medium transition-colors rounded-md text-foreground hover:text-teal"
          ...
          {navLinks.map((link) =>
            link.external ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-3 py-2 text-sm font-medium rounded-md transition-colors text-foreground hover:bg-section-alt"
