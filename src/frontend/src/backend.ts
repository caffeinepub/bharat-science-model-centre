...
import type { Catalogue as _Catalogue, Enquiry as _Enquiry, ExternalBlob as _ExternalBlob, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async listCatalogues(): Promise<Array<Catalogue>> {
        if (this.processError) {
            try {
                const result = await this.actor.listCatalogues();
    ...
    async submitEnquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: ExternalBlob | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitEnquiry(arg0, arg1, arg2, arg3, arg4, await to_candid_opt_n20(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadCatalogue(arg0: string, arg1: string, arg2: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadCatalogue(arg0, arg1, await to_candid_ExternalBlob_n21(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Catalogue_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Catalogue): Promise<Catalogue> {
    return await from_candid_record_n19(_uploadFile, _downloadFile, value);
}
async function from_candid_Enquiry_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Enquiry): Promise<Enquiry> {
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Enquiry>): Promise<Array<Enquiry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Enquiry_n11(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Catalogue>): Promise<Array<Catalogue>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Catalogue_n18(_uploadFile, _downloadFile, x)));
}
